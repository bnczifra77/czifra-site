...
export default function DarkModeToggle() {
  ...
  return (
    <button
      ...
      className="fixed right-4 bottom-4 z-50 bg-white dark:bg-[#0a1627] border border-gray-200 dark:border-gray-700 shadow-lg rounded-full p-3 flex items-center justify-center transition-colors hover:bg-blue-50 dark:hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-400"
      onClick={() => setDark((d) => !d)}
